const WORK_LIST = [
	...
	{
		media: [{ url: "img/encryption.png", alt: "Encryption Image", isVideo: false }],
		tags: ["python"],
		title: { text: "PRESENT-80 Encryption Algorithm Implementation", localizationKey: "present-80-title" },
		desc: {
			text: "Implementation of the encryption algorithm of the <strong>PRESENT-80</strong> lightweight block cipher using <strong>Python</strong>.",
			localizationKey: "present-80-desc"
		},
		footer: { text: null, localizationKey: null },
		buttons: [
			{
	...
	},
	{
		media: [{ url: "img/encryption.png", alt: "Encryption Image", isVideo: false }],
		tags: ["python"],
		title: { text: "AES-128 Encryption Algorithm in ECB Mode Implementation", localizationKey: "aes-128-ecb-title" },
		desc: {
			text: "Implementation of the encryption algorithm of the <strong>AES-128</strong> block cipher in <strong>ECB</strong> mode using <strong>Python</strong>.",
			localizationKey: "aes-128-ecb-desc"
		},
		footer: { text: null, localizationKey: null },
		buttons: [
			{
